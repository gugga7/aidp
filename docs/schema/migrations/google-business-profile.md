# Migrating from Google Business Profile to AIDP Schema

## Overview

This guide helps you convert Google Business Profile (GBP) data to AIDP Schema format. AIDP extends GBP with AI-optimized fields while maintaining compatibility with existing data.

## Key Differences

| Aspect | Google Business Profile | AIDP Schema |
|--------|------------------------|-------------|
