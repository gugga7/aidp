...
The Business Profile is the foundational entity in AIDP Schema, representing a local business optimized for AI discovery.

### Schema Structure Overview

![AIDP Schema Structure](../gitbook/.gitbook/assets/schema-structure.svg)
...
AIDP Schema follows semantic versioning:
