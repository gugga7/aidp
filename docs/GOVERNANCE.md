# AIDP Protocol Governance Model

## Overview

AIDP Protocol is an open standard maintained through community collaboration with clear governance processes. This document defines how the schema evolves, who makes decisions, and how contributors participate.
...
AIDP Protocol follows **Semantic Versioning 2.0.0**:
...
**Repository**: https://github.com/aidp-platform/aidp-protocol
...
Contributors retain copyright but grant AIDP Protocol project:
...
AIDP Protocol is released under **MIT License**:
...
"AIDP" and "AI Discovery Protocol" are trademarks of AIDP Platform:
...
Contributors agree not to assert patents against AIDP Protocol implementations.
